...
if __name__ == "__main__":
  hparams = {
    ...
    "learning_rate": 0.0007535012016081368,
    "weight_decay": 2.127070176843765e-05,
    "batch_size": 8,
    "num_workers": 8,
    "max_epochs": 1000,
  ...
  wandb.login(key="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")
  wandb_logger = WandbLogger(
      name=f"{hparams['model_name']}",
      project="byol_on_rtx",
      log_model=True,  # Changed to True to save model weights/checkpoints
      save_code=True,  # Added to save the training script code
  )
  # Uncomment the line below if you want to save ALL .py files in the project root:
  wandb_logger.experiment.log_code(PROJECT_ROOT)
  ...
  RESUME_CHECKPOINT = "/media/drive1/sazzat/rgc/byol_on_rtx/ww11rdut/checkpoints/epoch=199-step=40400.ckpt"
